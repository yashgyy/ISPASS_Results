...
def main():
    ...
    patterns = [
        'IC_AMDS_performance_pb*.csv',
        'IC_AMDS_perfomance_pb*.csv',  # Handle typo in filename
        'AMDS_IC_performance_pc*.csv',
        'AMDS_IC_perfomance_pc*.csv',  # Handle typo in filename
        'IC_AMDS_pb_energy*.csv',
        'AMDS_IC_pb_energy*.csv',
        'IC_AMDS_pb_performance*.csv',
        'AMDS_IC_pb_performance*.csv'
    ]
