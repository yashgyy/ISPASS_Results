...
def main():
    ...
    patterns = [
        'IC_IS_performance_pb*.csv',
        'IC_IS_perfomance_pb*.csv',  # Handle typo in filename
        'IS_IC_performance_pc*.csv',
        'IS_IC_perfomance_pc*.csv',  # Handle typo in filename
        'IC_IS_pb_energy*.csv',
        'IS_IC_pb_energy*.csv',
        'IC_IS_pb_performance*.csv',
        'IS_IC_pb_performance*.csv'
    ]
