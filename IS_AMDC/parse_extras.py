...
def main():
    ...
    patterns = [
        'IS_AMDC_performance_pb*.csv',
        'IS_AMDC_perfomance_pb*.csv',  # Handle typo in filename
        'AMDC_IS_performance_pc*.csv',
        'AMDC_IS_perfomance_pc*.csv',  # Handle typo in filename
        'IS_AMDC_pb_energy*.csv',
        'AMDC_IS_pb_energy*.csv',
        'IS_AMDC_pb_performance*.csv',
        'AMDC_IS_pb_performance*.csv'
    ]
